...
- 照旧我们进行 debug 当前方法为`toString`方法
  ...
  ![1575891988804](assets/1575891988804.png)

  从返回结果可以看到`sb.toString`返回的是： `返回值类型#方法名`

  ![1575892046692](assets/1575892046692.png)
